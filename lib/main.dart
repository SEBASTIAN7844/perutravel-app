...
// ELIMINAR: import 'package:firebase_core/firebase_core.dart';
...
void main() {
  // ELIMINAR Firebase.initializeApp();
    ...
    return MaterialApp(
      ...
      routes: {
        ...
        '/destination_detail': (context) {
          final destination = ModalRoute.of(context)!.settings.arguments as DestinationDetail;
